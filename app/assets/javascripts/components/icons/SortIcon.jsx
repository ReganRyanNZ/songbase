const SortIcon = props => {
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 489.389 489.389">
    <g>
      <path fill="#ccc" d="M261.294,326.102c-8.3-7.3-21.8-6.2-29.1,2.1l-77,86.8v-346.9c0-11.4-9.4-20.8-20.8-20.8s-20.8,9.4-20.8,20.8v346.9
      ...
      <path fill="#ccc" d="M483.994,134.702l-112.4-126.9c-10-10.1-22.5-10.7-31.2,0l-114.4,126.9c-7.3,8.3-6.2,21.8,2.1,29.1
